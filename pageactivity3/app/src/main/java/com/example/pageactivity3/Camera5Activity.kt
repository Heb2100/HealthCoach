...
import com.example.pageactivity3.databinding.ActivityCameraBinding
import java.io.File

class Camera5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Glide.with(this).load(R.drawable.inclinebenchpress1).into(imageView)
...
// 카메라 실행
        binding.btnRecord.setOnClickListener {
            ...
            videoUri = FileProvider.getUriForFile(
                this,
                "com.example.pageactivity3.fileprovider",
                videoFile
            )
